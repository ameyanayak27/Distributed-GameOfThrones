 ...
 * Exclusion Algorithm. The RABS.java represents a bootstrap server or a 
 ...
 * the Critical section and the BootStrap Server has information of all 
 * nodes in the system
 * 
 * @version  : RABS.java v 4.0  5/13/2015 10:00 PM
 * 
...
public class RABS extends UnicastRemoteObject implements NodeInterface,Serializable
{
    ...
    //Variable Specific to BootStrap Server
  	 ...
  	 */
  	public RABS(String sR) throws RemoteException
  	{
  		sRole = sR;
  	 ...
  	 * @throws RemoteException
  	 */
	protected RABS() throws RemoteException 
	{
		super();
		//Printing Menu
		System.out.println(" \n\n      The Iron Bank is Now Open\n\n");
		StartBootStrapping();
		//sc.close();
	}
